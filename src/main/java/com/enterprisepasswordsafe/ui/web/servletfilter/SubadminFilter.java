...
public final class SubadminFilter implements Filter {
    /**
	...
	public void doFilter(ServletRequest request, ServletResponse response,
        ...
        boolean isAdmin = (session.getAttribute("user_is_subadmin") != null);
        if (!isAdmin) {
            Logger.getAnonymousLogger().warning("Denied attempt to access subadmin area "+((HttpServletRequest)request).getRequestURL());
