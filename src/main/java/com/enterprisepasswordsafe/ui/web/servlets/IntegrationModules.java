...
public final class IntegrationModules extends HttpServlet {
	...
	protected void doGet(final HttpServletRequest request, final HttpServletResponse response)
    	...
    	try {
    		request.setAttribute("intmod_list", IntegrationModuleDAO.getInstance().getAll());
    	} catch(SQLException sqle) {
    		throw new ServletException("The integration module list is unavailable at the current time.", sqle);
    	}
	...
	public String getServletInfo() {
        return "Servlet to obtain the list of integration modules and direct the user to the appropriate page.";
    }
}
