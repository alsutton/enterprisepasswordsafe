...
/**
 * Role for a user and item.
 */
public class UserAccessRole extends AccessRole {

	/**
	 * Pass through storage constructor.
	 * 
	 * @param theItemId The ID of the item involved.
	 * @param theActorId The ID of the user involved.
	 * @param theRole The role.
	 */
	public UserAccessRole(String theItemId, String theActorId,
			String theRole) {
	 ...
	 */
	public UserAccessRole(ResultSet rs, int startIdx) throws SQLException {
		super(rs, startIdx);
	}
