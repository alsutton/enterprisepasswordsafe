...
public interface AccessControledObjectDAO {
	...
	public AccessControledObject getById(final User fetchingUser, final String id)
	...
	public void delete(final User deletingUser, final AccessControledObject aco)
		throws SQLException, UnsupportedEncodingException, GeneralSecurityException;
    ...
    public AccessControledObject getByIdForUser(final User theUser, final String id)
