...
import com.enterprisepasswordsafe.engine.jaas.AuthenticationSourceConfigurationOption;
...
public final class AuthenticationSource
    ...
    public void setProperties(final Map<String,String> map) {
        String testName = (String) map.remove(NAME_PARAMETER);
        if (testName != null) {
            name = testName;
        }

        String testJaasType = (String) map.remove(JAAS_TYPE_PARAMETER);
