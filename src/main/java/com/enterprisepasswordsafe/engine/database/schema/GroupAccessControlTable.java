...
public final class GroupAccessControlTable
	...
	private static final String TABLE_NAME = "group_access_control";
	...
	private static final ColumnSpecification[] COLUMNS = {
		GROUP_ID_COLUMN, ITEM_ID_COLUMN, RKEY_COLUMN, MKEY_COLUMN
	};
	...
	private static final ColumnSpecification[] ID_INDEX_COLUMNS = { GROUP_ID_COLUMN, ITEM_ID_COLUMN  };
	private static final IndexSpecification ID_INDEX = new IndexSpecification("gac_gidiid", TABLE_NAME, ID_INDEX_COLUMNS);

	private static final IndexSpecification ITEM_ID_INDEX = new IndexSpecification("gac_iid", TABLE_NAME, ITEM_ID_COLUMN);
	private static final IndexSpecification USER_ID_INDEX = new IndexSpecification("gac_uid", TABLE_NAME, GROUP_ID_COLUMN);
	...
	protected static GroupAccessControlTable getInstance() {
		return new GroupAccessControlTable();
	}
}
