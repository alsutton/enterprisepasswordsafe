 ...
 */
public final class NotesEqualsSearchTest implements SearchTest {
    /**
    ...
    public NotesEqualsSearchTest(final String searchString) {
    ...
    public boolean matches(final Password password) {
    	try {
	        ...
	        return (notes != null && notes.equalsIgnoreCase(testSearchString));
    	} catch (Exception e) {
    		return false;
    	}
    }
