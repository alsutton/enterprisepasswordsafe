...
public final class LocationsTable
	...
	private static final ColumnSpecification ID_COLUMN = new ColumnSpecification("id", ColumnSpecification.TYPE_ID);
    ...
    private static final IndexSpecification ID_INDEX = new IndexSpecification("loc_ids", TABLE_NAME, ID_COLUMN);
    private static final IndexSpecification NAME_INDEX = new IndexSpecification("loc_names", TABLE_NAME, NAME_COLUMN);
