 ...
 */
public final class UsernameEqualsSearchTest implements SearchTest {
    /**
    ...
    public UsernameEqualsSearchTest(final String username) {
    ...
    public boolean matches(final Password password) {
    	try {
	        ...
	        return (username != null && username.equalsIgnoreCase(testUsername));
    	} catch (Exception e) {
    		return false;
    	}	        
    }
