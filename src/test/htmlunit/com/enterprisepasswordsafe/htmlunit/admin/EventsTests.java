...
/**
 * Tests of the license setting system.
 */

public class EventsTests extends EPSTestBase {

    /**
     * Test submitting a license
     *
    ...
    public void testViewEvents()
    	...
    	response = response.getAnchorByHref(Constants.WebUI.EVENT_LOG_LINK).click();

        TestUtils.checkPageTitle(response, "View Events");
