...
import com.enterprisepasswordsafe.Configuration;
import com.enterprisepasswordsafe.database.schema.IntegrationModulesConfigurationTable;
import com.enterprisepasswordsafe.database.schema.PasswordHistoryTable;
import com.enterprisepasswordsafe.database.schema.PasswordRestrictionsTable;
import com.enterprisepasswordsafe.database.schema.PasswordsTable;
import com.enterprisepasswordsafe.database.schema.RestrictedAccessApproversTable;
import com.enterprisepasswordsafe.database.schema.RestrictedAccessRequestsTable;
...
public class SchemaVersion {
	...
	public void update()
		...
		synchronized(SchemaVersion.class) {
			...
			Configuration.getInstance().updateSchema(currentSchema);
