...
public class SchemaVersion {
	...
	void create()
		...
		ConfigurationDAO.getInstance().set(ConfigurationOptions.SCHEMA_VERSION, Long.toString(CURRENT_SCHEMA));
	}
	...
	private Long getCurrentSchemaVersion() {
		...
		return configurationDAO.getLongValue(ConfigurationOptions.SCHEMA_VERSION);
	}
