...
<jsp:include page="/WEB-INF/includes/hierarchy_breadcrumbs.jsp">
    <jsp:param name="explorerUrl" value="/subadmin/NodeUserPermissions" />
</jsp:include>
...
<div class="row">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="<c:url value='/subadmin/NodeUserPermissions'/>" name="eh_uperms">User Permissions</a></li>
...
<c:choose>
    <c:when test="${requestScope.node.nodeId eq '0'}">
        <div class="row">
            <div class="col-md-12">You can not set the permissions for the top level. All users must be able to access it
                in order to log in.
            </div>
        </div>
    </c:when>
    <c:otherwise>
        <div class="row">
            <div class="col-md-12">
                ...
                <li>User permissions take precedence over group permissions.</li>
                </ol>
            </div>
        </div>
        ...
        <c:if test="${not empty requestScope.perms}">
            <form action="<c:url value='/subadmin/UpdateHierarchyPermissions'/>"  method="POST" accept-charset="ISO-8859-1" name="permset" role="form">
                <input type="hidden" name="nodeId" value="${requestScope.node.nodeId}" />

                <div class="row">
                    <div class="col-md-12">
                        <table class="table">
                            <thead><tr><td>User</td><td>Permissions</td></tr></thead>
