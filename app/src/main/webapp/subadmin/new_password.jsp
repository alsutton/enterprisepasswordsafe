...
<body>
<form action="<c:url value='/system/CreateNewPassword'/>" method="POST" accept-charset="ISO-8859-1" name="editform" role="form" class="form-horizontal">
...
<!-- TODO: Autocomplete location using locations_set -->
    ...
    <div class="row">
        <div class="col-md-12 text-right">
            <c:url var="generateLink" value="/GeneratePassword">
                <c:param name="rid" value="${requestScope.restriction_id}"/>
            </c:url>
            <a href="${generateLink}" class="btn btn-xs btn-default" target="_blank">Open Password Generator</a>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            <c:choose>
                <c:when test="${noExpiry eq 'Y'}"><c:set var="expiry" value=""/></c:when>
                    ...
                    <c:forEach var="thisField" varStatus="status" items="${requestScope.cfields}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1">
                                ...
                                <input	type="checkbox" id="cfd_${customFieldIdx}" name="cfd_${customFieldIdx}" class="form-control" />
                            </div>
                        </div>
                    </c:forEach>
                </c:when>
