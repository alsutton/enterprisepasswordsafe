        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <c:choose>
                        <c:when test="${not empty sessionScope.user_is_admin}">
                            <%@include file="/WEB-INF/includes/navmenu_admin.jsp" %>
                        </c:when>
                        <c:when test="${not empty sessionScope.user_is_subadmin}">
                            <%@include file="/WEB-INF/includes/navmenu_subadmin.jsp" %>
                        </c:when>
                        <c:otherwise>
                            <%@include file="/WEB-INF/includes/navmenu_user.jsp" %>
                        </c:otherwise>
                    </c:choose>
                    <li><a href="<c:url value='/system/Profile'/>">Profile</a></li>
