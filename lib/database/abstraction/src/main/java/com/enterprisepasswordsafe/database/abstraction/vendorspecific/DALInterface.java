...
public interface DALInterface
{
	...
	String addCreationURLParameters(final String url);
	...
	void createTable(TableSpecification spec)
		throws SQLException;
	...
	void addColumn(String tableName, ColumnSpecification spec)
		throws SQLException;
	...
	void renameColumn(String tableName, String oldName, String newName, ColumnSpecification.Type type)
		throws SQLException;
	...
	void addIndex(IndexSpecification specification)
		throws SQLException;
	...
	boolean runSQLQuery(String sql)
		throws SQLException;
