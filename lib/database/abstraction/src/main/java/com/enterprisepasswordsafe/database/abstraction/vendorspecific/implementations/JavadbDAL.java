	...
	extends AbstractDAL
{
	 ...
	 */
	public JavadbDAL(Connection conn)
	{
		super(conn);

		translationMap.put( ColumnSpecification.Type.LONG, "INTEGER" );
		translationMap.put( ColumnSpecification.Type.INT, "INTEGER" );
		translationMap.put( ColumnSpecification.Type.CHAR, "CHARACTER" );
		translationMap.put( ColumnSpecification.Type.ID, "CHARACTER VARYING(20)" );
		translationMap.put( ColumnSpecification.Type.SHORT_STRING, "CHARACTER VARYING(255)" );
		translationMap.put( ColumnSpecification.Type.LONG_STRING, "CHARACTER VARYING(3072)" );
		translationMap.put( ColumnSpecification.Type.BLOB, "BLOB" );
		translationMap.put( ColumnSpecification.Type.MULTI_BLOB, "BLOB" );
		translationMap.put( ColumnSpecification.Type.KEY, "BLOB" );
		translationMap.put( ColumnSpecification.Type.IP_ADDRESS, "CHARACTER VARYING(50)" );
