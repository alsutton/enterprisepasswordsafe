...
/**
 * Database Abstraction Layer for MS SQL Server databases
 */
	...
	extends AbstractDAL
{
	 ...
	 */
	public SqlserverDAL(Connection conn)
	{
		super(conn);

		translationMap.put( ColumnSpecification.Type.LONG, "LONG" );
		...
		translationMap.put( ColumnSpecification.Type.BLOB, "IMAGE" );
		translationMap.put( ColumnSpecification.Type.MULTI_BLOB, "IMAGE" );
	...
	public void renameColumn( final String tableName, 
		...
		throws SQLException {
		runSQLUpdate( "sp_rename '"+tableName+'.'+oldName+"', '"+newName+"', 'COLUMN'" );
	}
}
