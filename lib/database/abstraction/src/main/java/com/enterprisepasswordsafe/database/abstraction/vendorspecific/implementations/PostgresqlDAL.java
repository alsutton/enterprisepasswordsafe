	...
	extends AbstractDAL
{
	 ...
	 */
	public PostgresqlDAL(Connection conn)
	{
		super(conn);
		...
		translationMap.put( ColumnSpecification.Type.BLOB, "BYTEA" );
		translationMap.put( ColumnSpecification.Type.MULTI_BLOB, "BYTEA" );
		translationMap.put( ColumnSpecification.Type.KEY, "BYTEA" );
