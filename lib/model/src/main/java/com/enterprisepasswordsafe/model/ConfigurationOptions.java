...
public enum ConfigurationOptions {
    ...
    DEFAULT_LOGIN_ACCESS("user.login_access", Boolean.TRUE.toString()),
    DEFAULT_HIERARCHY_ACCESS_RULE("hierarchy.default_rule", Boolean.TRUE.toString()),
    EDIT_USER_MINIMUM_USER_LEVEL("hierarchy.edit_userlevel", "A"),
    HIDDEN_PASSWORD_ENTRY("password.entry_hidden", "true"),
    HIDE_EMPTY_FOLDERS("hierarchy.hide_empty", Boolean.TRUE.toString()),
    ...
    STORE_PASSWORD_HISTORY("password.history", HistoryRecording.CREATOR_CHOOSES.toString()),
    ...
    ConfigurationOptions(final String propertyName, final String defaultValue) {
