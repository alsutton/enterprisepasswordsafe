...
public class UserAccessRoleDAO extends JPADAOBase<UserAccessRole> {
	private UserAccessRoleDAO(DAORepository daoRepository, EntityManager entityManager) {
		super(daoRepository, entityManager, UserAccessRole.class);
	}
}
